...
@section('content')
    <div class="">
        ...
        <form action="{{ route('categories.store') }}" method="POST" class="flex flex-col max-w-lg mx-auto my-5 border p-5 rounded shadow-lg">
            @csrf
            ...
            <button type="submit"
                class="bg-gradient-to-r from-indigo-500 to-blue-500 bg-indigo-500 text-white font-bold py-2 px-4 rounded-md mt-4 hover:bg-indigo-600 hover:to-blue-600 transition ease-in-out duration-150">Create</button>
