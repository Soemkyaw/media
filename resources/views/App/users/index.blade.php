        ...
        <ul class="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400 rtl:divide-x-reverse"
            ...
            <li class="w-full">
                <button id="stats-tab" data-tabs-target="#stats" type="button" role="tab" aria-controls="stats"
                    aria-selected="true"
                    class="inline-block w-full p-4 rounded-ss-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Users</button>
            </li>
            <li class="w-full">
                <button id="about-tab" data-tabs-target="#about" type="button" role="tab" aria-controls="about"
                    aria-selected="false"
                    class="inline-block w-full p-4 bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Admins</button>
            </li>
        </ul>
                ...
                <div class=" mb-5">
                    <form class="max-w-md ms-auto">
                        ...
                        <div class="relative">
                            ...
                            <input type="search" id="default-search" name="searchKey"
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <td scope="row" class="px-6 py-4">
                                        @if ($user->profile_picture)
                                            <img src="{{ asset('storage/' . $user->profile_picture) }}" class=" w-20 rounded-full shadow-lg">
                                        @else
                                            <img src="{{ asset('images/user-default.png') }}" class=" w-20 rounded-full shadow-lg">
                                        @endif
                                    </td>
                                    <td class="px-6 py-4">
                                        {{ $user->name }}
                                        ...
                                        <div class=" flex justify-between">
                                            <a href="{{ route('user.show',$user->id) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    ...
                                                    class=" w-6 text-gray-500 hover:text-gray-800">
